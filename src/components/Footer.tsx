...
const Footer: React.FC<FooterProps> = ({ className = "" }) => {
  ...
  return (
    <footer className={`bg-black/90 backdrop-blur-sm border-t border-green-400/20 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          
          {/* Left: Live Date & Time */}
          <div className="text-green-400 text-sm font-mono order-2 md:order-1">
          ...
          <div className="flex items-center space-x-4 order-1 md:order-2">
            {portfolioData.socialLinks.map((social) => (
              <a
                ...
                className="group text-green-400 hover:text-green-300 transition-all duration-200 p-2 rounded-lg border border-green-400/20 hover:border-green-400/40 hover:bg-green-400/5"
          ...
          <div className="order-3">
            <button
              onClick={scrollToTop}
              className="group flex items-center space-x-2 text-green-400 hover:text-green-300 transition-all duration-200 p-2 rounded-lg border border-green-400/20 hover:border-green-400/40 hover:bg-green-400/5"
            ...
            >
              ...
              <span className="text-sm font-medium hidden sm:inline">Top</span>
            </button>
          </div>
        </div>

        {/* Copyright */}
        {/* <div className="mt-6 pt-4 border-t border-green-400/20 text-center">
          <p className="text-gray-400 text-xs">
            © 2025 Yash Suthar. Built with Next.js, TypeScript & ❤️
          </p>
        </div> */}
      </div>
