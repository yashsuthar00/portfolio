...
export const portfolioData: PortfolioData = {
  ...
  skills: [
    ...
    {
      category: "Frontend",
      items: ["React", "Next.js", "Vue.js", "HTML5", "CSS3", "Tailwind CSS", "Three.js"]
    },
    {
      category: "Backend",
      items: ["Node.js", "Express.js", "FastAPI", "Django", "PostgreSQL", "MongoDB", "Redis"]
    },
    {
      category: "DevOps & Tools",
      items: ["Docker", "Kubernetes", "AWS", "Git", "GitHub Actions", "Jenkins", "Nginx"]
    },
    {
      category: "Other",
      items: ["GraphQL", "REST APIs", "Microservices", "WebSockets", "PWA", "Testing"]
    }
  ],
  experience: [
    {
  ...
  projects: [
    {
      ...
      description: "A unique portfolio website with Linux terminal interface and 3D interactive elements built with Next.js and Three.js",
      technologies: ["Next.js", "TypeScript", "Three.js", "Xterm.js", "Tailwind CSS"],
